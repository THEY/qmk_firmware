 ...
 */
  ...
  [_QWERTY] = LAYOUT_ortho_5x14(
    ...
    KC_TAB          , KC_Q   , KC_W   , KC_E      , KC_R   , KC_T   , KC_VOLD,         KC_VOLU, KC_Y   , KC_U   , KC_I      , KC_O   , KC_P   , KC_LBRC,
    CTL_T(KC_ESCAPE), KC_A   , KC_S   , KC_D      , KC_F   , KC_G   , KC_LCBR,         KC_RBRC, KC_H   , KC_J   , KC_K      , KC_L   , KC_SCLN, KC_QUOT,
    KC_LSFT         , KC_Z   , KC_X   , KC_C      , KC_V   , KC_B   , KC_LBRC,         KC_RCBR, KC_N   , KC_M   , KC_COMM   , KC_DOT , KC_SLSH, KC_RSFT,
    KC_LALT         , KC_MEH , KC_NO  , MO(_LOWER), KC_LGUI, KC_NO  , KC_ENT ,         KC_SPC , KC_NO  , KC_RGUI, MO(_RAISE), KC_NO  , KC_NO  , KC_NO
  ),
