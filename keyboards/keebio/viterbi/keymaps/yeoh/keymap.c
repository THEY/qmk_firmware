...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT_ortho_5x14(
    ...
    CTL_T(KC_ESCAPE), KC_A   , KC_S   , KC_D      , KC_F   , KC_G   , KC_LCBR,         KC_RCBR, KC_H   , KC_J   , KC_K      , KC_L   , KC_SCLN, CTL_T(KC_QUOT),
  ...
  [_LOWER] = LAYOUT_ortho_5x14(
    ...
    RESET,   KC_NO,        KC_NO,        MO(_LOWER),        KC_NO,              KC_ENT, KC_MPRV, KC_MNXT, KC_SPC,        KC_NO,                   MO(_RAISE),              KC_NO,          KC_NO,           KC_NO
  ),
