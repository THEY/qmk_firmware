 ...
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 * |        |        |        | CMD+[  | CMD+]  |        |        | MUTE   |        | CMD+LT | ALT+LF | ALT+RT | CMD+RT |        |        |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 * |RESET   |        |        | FN     |        |        |        |        |        |        |        |  FN    |        |        |        |
 * '--------------------------------------------------------------------------------------------------------------------------------------'
 */
...
// };
 ...
 [_FN] = { /* FUNCTION */
  ...
  { KC_NO,   KC_NO,   KC_NO,   KC_NO,             KC_NO,              KC_NO,  KC_MPRV, KC_MPLY,   KC_MNXT, KC_LEFT,   KC_DOWN,   KC_UP,   KC_RGHT,  KC_NO,  KC_NO },
  { KC_NO,   KC_NO,   KC_NO,   LGUI(KC_LBRACKET), LGUI(KC_RBRACKET),  KC_NO,  KC_NO,   KC_MUTE,   KC_NO,   LGUI(KC_LEFT), LALT(KC_LEFT), LALT(KC_RIGHT), LGUI(KC_RIGHT), LGUI(KC_SLASH),  KC_NO,  KC_NO },
  { RESET,   KC_NO,   KC_NO,   MO(_FN),           KC_NO,              KC_NO,  KC_NO,   KC_NO,     KC_NO,   KC_NO,     KC_NO,   MO(_FN),   KC_NO,  KC_NO,  KC_NO },
 }
};
